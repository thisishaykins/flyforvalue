...
<head>
    ...
    <title>Book Awesome Trip, Flights, Hotels & Packages - FlyForValue</title>
    <!-- Font Google -->
        ...
        <header id="header" class="header">
            <div class="container">
                ...
                <div class="logo float-left">
                    <a href="index.html" title=""><img src="images/logo-flyforvalue.jpeg" alt=""></a>
                </div>
                <!-- End Logo -->
                <!-- Bars -->
                        ...
                        <div class="flight-deal-item">
                            ...
                            <div class="flight-text">
                                ...
                                <div class="flight-price">
                                    One way fare only
                                    <span class="price">₦847933.50</span>
                                    depart from Paris
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flight-deal-item">
                            ...
                            <div class="flight-text">
                                ...
                                <div class="flight-price">
                                    ...
                                    <span class="price">₦847933.258</span>
                                    depart from Hanoi
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xs-6 col-md-4 col-lg-3">
                        <div class="flight-deal-item">
                            ...
                            <div class="flight-text">
                                ...
                                <div class="flight-price">
                                    One way fare only
                                    <span class="price">₦847933.175</span>
                                    depart from Moscow
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xs-6 col-md-4 col-lg-3">
                        <div class="flight-deal-item">
                            ...
                            <div class="flight-text">
                                ...
                                <div class="flight-price">
                                    One way fare only
                                    <span class="price">₦847933.150</span>
                                    depart from Taipei
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xs-6 col-md-4 col-lg-3">
                        <div class="flight-deal-item">
                            ...
                            <div class="flight-text">
                                ...
                                <div class="flight-price">
                                    One way fare only
                                    <span class="price">₦847933.214</span>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-4">
                        ...
                        <!--CopyRight-->
                        <p class="copyright">
                            © 2015 – 2019 FlyForValue All rights reserved.
                        </p>
                        <!--CopyRight-->
                    </div>
